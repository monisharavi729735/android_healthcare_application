...
public class BookAppointmentActivity extends AppCompatActivity {
    ...
    EditText textViewFees; // Declare the fees EditText
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textViewFees = findViewById(R.id.editTextAppFees); // Initialize the fees EditText
        ...
        bookbtn.setOnClickListener(view -> {
            ...
            float feeValue;
            try {
                feeValue = Float.parseFloat(fees.replace("Fees: ", "")); // Remove "Fees: " before parsing
